...
public final class MsrUpdateProfiler implements ExternalProfiler {
  public MsrUpdateProfiler() {}
  ...
  public Collection<? extends Result> afterTrial(
    ...
    List<ScalarResult> results =
        forwardApply(
            forwardApply(
                    MsrUpdateBenchmark.samples.stream()
    ...
    MsrUpdateBenchmark.samples.clear();
    return results;
  }
